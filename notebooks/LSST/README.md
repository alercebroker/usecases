...
We suggest to explore the notebooks in the following order:
* [ALeRCE_LSST_Tables.ipynb](https://github.com/alercebroker/usecases/blob/master/notebooks/LSST/ALeRCE_LSST_Tables.ipynb)
